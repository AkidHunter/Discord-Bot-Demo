...
module.exports = {
    name: "status",
    description: "Show the bot's status info",
    ...
    async execute(interaction, client) {
        ...
        const response = new MessageEmbed()
            ...
            .addFields({
                ...
                name: `<:reply:1002181954864681030> GENERAL`,
                value: 
                `
                ...
                **\`•\` Uptime**: ${moment.duration(parseInt(client.uptime)).format(" D [days], H [hrs], m [mins], s [secs]")}
                ...
                name: `<:reply:1002181954864681030> DATABASE`,
                value: 
                `
                **\`•\` Connection**: ${switchTo(connection.readyState)}
                ...
                name: `<:reply:1002181954864681030> HARDWARE`,
                value: 
                `
        ...
        interaction.channel.send({ embeds: [response], files: [attachment]});
        interaction.reply({ content: 'Status sent!', ephemeral: true });
    }
}
